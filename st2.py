        ...
        try:
            ...
            #   )
                ...
                if total==5:
                    ...
                    # st.markdown('---')
                    original_title = '<p style="font-family:Arial Black; color:Blue; font-size: 30px;">Acclerate</p>'
                ...
                if total==4:
                    # st.text('Right')
                    original_title = '<p style="font-family:Arial Black; color:Blue; font-size: 30px;">Right</p>'
                    st.markdown(original_title, unsafe_allow_html=True)
                ...
                if total==2 or total==3:
                    # st.text('Left')
                    original_title = '<p style="font-family:Arial Black; color:Blue; font-size: 30px;">Left</p>'
                    st.markdown(original_title, unsafe_allow_html=True)
                ...
                if total==0:
                    # st.text('Brake')
                    original_title = '<p style="font-family:Arial Black; color:Blue; font-size: 30px;">Brake</p>'
                    st.markdown(original_title, unsafe_allow_html=True)
